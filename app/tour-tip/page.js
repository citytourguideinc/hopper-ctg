    ...
    <main style={{minHeight:"100vh",background:"#F8FAFC",padding:"28px 18px"}}>
      <section style={{maxWidth:440,margin:"0 auto"}}>
        ...
        <div style={{background:"white",padding:22,borderRadius:"0 0 20px 20px",boxShadow:"0 10px 35px rgba(0,0,0,.08)"}}>
          <p style={{color:"#64748B",fontSize:".9rem",lineHeight:1.6,marginTop:0}}>If you enjoyed your tour and would like to leave a gratuity, enter any amount below. Thank you for supporting your tour guide.</p>
          ...
          <label style={{display:"block",fontWeight:700,fontSize:".82rem",margin:"18px 0 7px"}}>Gratuity amount</label>
